...
public class Board {
	...
	public void createBoard() {
		...
		// Bottom row
		b.makeSpace(board[10][10], SpaceColor.Blank, "GO", 0, 0, 0, 0, false, SpaceType.Go, 1);
		b.makeSpace(board[10][9], SpaceColor.Purple, "Mediteranian Avenue", 2, 30, 50, 60, true, SpaceType.Property, 2);
		b.makeSpace(board[10][8], SpaceColor.Blank, "Community Chest", 0, 0, 0, 0, false, SpaceType.CardDraw, 3);
		b.makeSpace(board[10][7], SpaceColor.Purple, "Baltic Avenue", 4, 30, 50, 60, true, SpaceType.Property, 4);
		b.makeSpace(board[10][6], SpaceColor.Blank, "Income Tax", 200, 0, 0, 200, false, SpaceType.Tax, 5);
		b.makeSpace(board[10][5], SpaceColor.Railroad, "Reading Railroad", 25, 100, 0, 200, true, SpaceType.Property, 6);
		b.makeSpace(board[10][4], SpaceColor.Silver, "Oriental Avenue", 6, 50, 50, 100, true, SpaceType.Property, 7);
		b.makeSpace(board[10][3], SpaceColor.Blank, "Chance", 0, 0, 0, 0,  true, SpaceType.CardDraw, 8);
		b.makeSpace(board[10][2], SpaceColor.Silver, "Vermont Avene", 6, 50, 50, 100, true, SpaceType.Property, 9);
		b.makeSpace(board[10][1], SpaceColor.Silver, "Connecticut Avenue", 8, 60, 50, 120, true, SpaceType.Property, 10);

		// Left Column
		b.makeSpace(board[10][0], SpaceColor.Blank, "Jail", 0, 0, 0, 0, false, SpaceType.Jail, 11);
		b.makeSpace(board[9][0], SpaceColor.Pink, "St. Charles Place", 10, 70, 100, 140, true, SpaceType.Property, 12);
		...
		b.makeSpace(board[1][0], SpaceColor.Orange, "New York Avenue", 16, 100, 100, 200, true, SpaceType.Property, 20);
		b.makeSpace(board[0][0], SpaceColor.Blank, "Free Parking", 0, 0, 0, 0, false, SpaceType.FreeParking, 21);

		// Top Row
		b.makeSpace(board[0][1], SpaceColor.Red, "Kentucky Avenue", 18, 110, 150, 220, true, SpaceType.Property, 22);
		b.makeSpace(board[0][2], SpaceColor.Blank, "Chance", 0, 0, 0, 0, false, SpaceType.CardDraw, 23);
		b.makeSpace(board[0][3], SpaceColor.Red, "Indiana Avenue", 18, 110, 150, 220, true, SpaceType.Property, 24);
		b.makeSpace(board[0][4], SpaceColor.Red, "Illinois Avenue", 20, 120, 150, 220, true, SpaceType.Property, 25);
		b.makeSpace(board[0][5], SpaceColor.Railroad, "B & O RailRoad", 25, 100, 0, 200, true, SpaceType.Property, 26);
		b.makeSpace(board[0][6], SpaceColor.Yellow, "Atlantic Avenue", 22, 130, 150, 260, true, SpaceType.Property, 27);
		b.makeSpace(board[0][7], SpaceColor.Yellow, "Ventnor Avenue", 22, 130, 150, 260, true, SpaceType.Property, 28);
		b.makeSpace(board[0][8], SpaceColor.Utilities, "Water Works", 0, 0, 0, 150, true, SpaceType.Utilities, 29);
		b.makeSpace(board[0][9], SpaceColor.Yellow, "Marvin Gardens", 24, 140, 150, 280, true, SpaceType.Property, 30);
		b.makeSpace(board[0][10], SpaceColor.Blank, "Go To Jail", 0, 0, 0, 0, false, SpaceType.Jail, 31);

		// Right Column
		b.makeSpace(board[1][10], SpaceColor.Green, "Pacific Avenue", 26, 150, 200, 300, true, SpaceType.Property, 32);
		b.makeSpace(board[2][10], SpaceColor.Green, "North Carolina Avenue", 26, 150, 200, 300, true, SpaceType.Property,
				33);
		b.makeSpace(board[3][10], SpaceColor.Blank, "Community Chest", 0, 0, 0, 0, false, SpaceType.CardDraw, 34);
		b.makeSpace(board[4][10], SpaceColor.Green, "Pennsylvania Avenue", 28, 160, 200, 320, true, SpaceType.Property, 35);
		b.makeSpace(board[5][10], SpaceColor.Railroad, "Short Line", 25, 100, 0, 200, true, SpaceType.Property, 36);
		b.makeSpace(board[6][10], SpaceColor.Blank, "Chance", 0, 0, 0, 0, false, SpaceType.CardDraw, 37);
		b.makeSpace(board[7][10], SpaceColor.Blue, "Park Place", 35, 175, 200, 350, true, SpaceType.Property, 38);
		b.makeSpace(board[8][10], SpaceColor.Blank, "Luxury Tax", 0, 0, 0, 0, false, SpaceType.Tax, 39);
		b.makeSpace(board[9][10], SpaceColor.Blue, "Boardwalk", 50, 200, 200, 400, true, SpaceType.Property, 40);
