...
public class Board {
	...
	public void createBoard() {
				...
				b.makeSpace(board[5][0], SpaceColor.Railroad, "Pennsylvania RailRoad", 25, 100, 0, true, SpaceType.Property, 15);
				...
				b.makeSpace(board[2][10], SpaceColor.Green, "North Carolina Avenue", 26, 150, 200, true, SpaceType.Property, 32);
